...
# COPY lands as root, so the unprivileged user cannot write anything under /app -
# including a SQLite file, which is how a local or CI run of this image starts.
